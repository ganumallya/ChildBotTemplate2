        ...
        function (session, args, next) {
            ...
            if(args.intent.entities.length>0){
                if(args.intent.entities[0].resolution.values[0].toLowerCase().includes('hours')){
                    resp = "Office working hours are 9:00 AM to 6:30 PM. Minimum working hours are 5 hour per day and you can avail half day leave if not completing 9 hours 30 mins per day."
